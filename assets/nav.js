...
`;
  ...
  var HP_DICT = {
    en: {
      ...
      'index.currencies.h2.html':'Send to <em>50+ markets.</em>',
      ...
      'sol-ecom.cov.h2.html':'50+ markets, <em>one platform.</em>',
      ...
      'pp.stat1.val':'MiCAR','pp.stat2.val':'<10 sec','pp.stat3.val':'0.10%','pp.stat4.val':'50+',
      ...
      'pe.embed.card3.body':'Send and receive payments across 50+ markets worldwide through a single API. Payouts settle in seconds, not days.',
      ...
      'prs.offer.card2.body':'Institutional rates with full spread transparency. FX spreads from 0.20% on major currencies, compared to 1 to 3% at high-street banks.',
      ...
      'pr.offer.card2.body':'Institutional rates with full spread transparency. FX spreads from 0.20% on major currencies, compared to 1 to 3% at high-street banks.',
      ...
      'index.vp.lede':'HansePay gives European businesses direct access to interbank FX rates with a transparent margin from 0.20% on major currency pairs, disclosed before every trade, with no hidden spread. Add same-day settlement on major corridors, and cross-border payments become predictable.',
      ...
      'index.platform.f3.title':'Recipient management','index.platform.f3.desc':'Store verified beneficiaries across 50+ markets, IBAN, SWIFT, local formats.',
      ...
      'index.faq.a2':'A transparent FX margin, from 0.20% on major currency pairs (0.20% to 0.75%) and disclosed before every trade, plus a flat €10 per payment. No spread hidden in the rate, no monthly fees, no minimum commitment.',
      'index.faq.q3':'Which currencies and countries do you support?',
      'index.faq.a3':'50+ markets across the Americas, Africa, the Middle East, Asia & Pacific, and Europe, including USD, GBP, JPY, AED, CNY, AUD, CAD, SGD, BRL, INR, KRW, ZAR, and more. Need a specific corridor? Get in touch, we can often arrange it on request.',
    ...
    de: {
      ...
      'index.vp.lede':'HansePay gibt europäischen Unternehmen direkten Zugang zu Interbanken-Kursen mit einer transparenten Marge ab 0,20 % auf Hauptwährungspaaren, vor jedem Handel offengelegt, ohne versteckten Spread. Mit Abwicklung am selben Tag auf den Hauptkorridoren werden grenzüberschreitende Zahlungen planbar.',
      ...
      'index.platform.f3.desc':'Verifizierte Begünstigte in 50+ Märkten speichern — IBAN, SWIFT, lokale Formate.',
      ...
      'index.currencies.h2':'In 50+ Märkte senden.',
      ...
      'index.faq.a2':'Eine transparente FX-Marge, ab 0,20 % auf Hauptwährungspaaren (0,20 % bis 0,75 %) und vor jedem Handel offengelegt, zuzüglich pauschal 10 € pro Zahlung. Kein im Kurs versteckter Spread, keine Monatsgebühren, keine Mindestlaufzeit.',
      'index.faq.q3':'Welche Währungen und Länder werden unterstützt?',
      'index.faq.a3':'50+ Märkte in Nord- und Südamerika, Afrika, dem Nahen Osten, Asien & Pazifik und Europa — darunter USD, GBP, JPY, AED, CNY, AUD, CAD, SGD, BRL, INR, KRW, ZAR und mehr. Benötigen Sie einen bestimmten Korridor? Kontaktieren Sie uns — wir können ihn oft auf Anfrage einrichten.',
      ...
      'sol-ecom.comp.row1.hp.val':'0,20 % bis 0,75 %',
      ...
      'sol-ecom.comp.row3.hp.val':'50+ Märkte weltweit',
      ...
      'sol-ecom.faq.1.a':'Ja. Die Sendewährung ist EUR. Wir zahlen in der Landeswährung (oder USD, wo lokal üblich) in 50+ Märkten weltweit aus, einschließlich der meisten Schwellenmärkte.',
      ...
      'sol-mfg.cov.h2':'50+ Märkte, eine Plattform.',
      ...
      'sol-log.faq.2.a':'Ja. Die Sendewährung ist EUR. Wir zahlen in der Landeswährung (oder USD, wo lokal üblich) in 50+ Märkten weltweit aus. Lokale Zahlungsschienen, wo verfügbar — deshalb landen die meisten Zahlungen am selben Tag.',
      ...
      'sol-log.cta.sub':'Same-Day-Zahlungen, 50+ Märkte, Wholesale-FX-Preise. Entwickelt für den Frachtzeitplan.',
      ...
      'sol-log.comp.row3.hp':'50+ Märkte weltweit',
      ...
      'sol-corp.feat.3.desc':'Gegenparteien in ihrer Landeswährung in 50+ Märkten weltweit bezahlen, einschließlich Schwellenmärkte, wo Standardbanken häufig blockieren oder Aufschläge erheben.',
      ...
      'sol-corp.persona.4.desc':'Beschaffung in Asien, Afrika und Lateinamerika. Zugang zu Korridoren, die die meisten Banken nicht bedienen, in 50+ Märkten weltweit, mit namentlichen Kontakten für institutionelle Volumina.',
      ...
      'sol-corp.comp.row3.hp.val':'50+ Märkte weltweit',
      ...
      'sol-corp.cov.h2':'50+ Märkte, eine Plattform.',
      ...
      'sol-sme.feat.3.desc':'Gegenparteien in ihrer Landeswährung in 50+ Märkten weltweit bezahlen, einschließlich Schwellenmärkte, wo Standardbanken häufig blockieren oder Aufschläge erheben.',
      ...
      'sol-sme.cov.h2':'50+ Märkte, eine Plattform.',
      ...
      'sol-sme.faq.5.a':'HansePay deckt 50+ Märkte ab, einschließlich vieler Schwellenmärkte, wo Standardbanken blockieren oder Aufschläge erheben. Jede Transaktion wird nach EU-AML- und KYC-Vorschriften geprüft. Sprechen Sie mit unserem Spezialisten über Ihren spezifischen Korridor.',
      ...
      'platform.pillars.p1.desc':'Wir beziehen den Interbanken-Mid-Market-Kurs und fügen eine transparente Marge hinzu, ab 0,20 % auf Hauptwährungspaaren, vor jedem Handel offengelegt. Kein im Kurs versteckter Spread, keine Überraschungen.',
      ...
      'platform.coverage.h2':'50+ Märkte, eine Plattform.',
      ...
      'platform.faq.a2':'Wir beziehen den Interbanken-Mid-Market-Kurs und fügen eine transparente Marge hinzu, ab 0,20 % auf Hauptwährungspaaren (0,20 % bis 0,75 %), vor jedem Handel offengelegt. Es gibt keinen im Kurs versteckten Spread, sodass Sie immer genau wissen, was die Zahlung kostet, bevor Sie bestätigen.',
      ...
      'platform.faq.a4':'50+ Märkte in Nord- und Südamerika, Afrika, dem Nahen Osten, Asien & Pazifik und Europa — darunter USD, GBP, JPY, CNY, AED, BRL, INR, CAD, AUD, SGD, HKD, MXN, KRW, ZAR und mehr. Für weniger gängige Korridore sind individuelle Vereinbarungen verfügbar — sprechen Sie mit einem unserer FX-Händler.',
      ...
      'index.currencies.h2.html':'Zahlungen in <em>50+ Märkte.</em>',
      ...
      'sol-ecom.cov.h2.html':'50+ Märkte, <em>eine Plattform.</em>',
      ...
      'platform-tech.s4.h2.html':'1,2 % versus 0,20–0,75 %. So verschwindet <em>der Unterschied.</em>',
      ...
      'platform-tech.s8.a2':'PayPal ist ebenfalls ein E-Geld-Institut nach EU-Recht — derselbe rechtliche Rahmen. Der Unterschied liegt im Umfang und den Konditionen. PayPal optimiert für Verbraucherzahlungen bei rund 3 % pro Transaktion. HansePay optimiert für grenzüberschreitende Geschäftszahlungen ab 0,20 % bei wichtigen Währungspaaren.',
      ...
      'sol-corp.trust.2':'50+ Märkte weltweit',
      ...
      'sol-ecom.feat.2.title':'50+ Märkte weltweit',
      ...
      'sol-ecom.trust.1':'50+ Märkte weltweit',
      ...
      'sol-log.feat.2.desc':'Bezahlen Sie Gegenparteien in ihrer Landeswährung in 50+ Märkten weltweit, einschließlich Schwellenmärkten, in denen Standardbanken häufig blockieren oder Aufschläge verlangen.',
      ...
      'sol-log.hero.overlay.sub':'50+ Märkte',
      ...
      'sol-log.trust.2':'50+ Märkte weltweit',
      ...
      'sol-mfg.comp.row3.hp.main':'50+ Märkte weltweit',
      ...
      'sol-mfg.feat.3.desc':'Bezahlen Sie Gegenparteien in ihrer Landeswährung in 50+ Märkten weltweit, einschließlich Schwellenmärkten, in denen Standardbanken häufig blockieren oder Aufschläge verlangen.',
      ...
      'sol-mfg.trust.3':'50+ Märkte weltweit',
      ...
      'sol-sme.trust.3':'50+ Märkte weltweit',
      ...
      'pr.offer.card2.body':'Institutionelle Kurse mit vollständiger Spread-Transparenz. FX-Spreads ab 0,20 % auf Hauptwährungen, gegenüber 1 bis 3 % bei Filialbanken.',
      ...
      'pp.stat1.val':'MiCAR','pp.stat2.val':'<10 Sek.','pp.stat3.val':'0,10 %','pp.stat4.val':'50+',
      ...
      'pe.embed.card3.body':'Zahlungen über 50+ Märkte weltweit über eine einzelne API senden und empfangen. Auszahlungen in Sekunden abgewickelt, nicht in Tagen.',
      ...
      'prs.offer.card2.body':'Institutionelle Kurse mit vollständiger Spread-Transparenz. FX-Spreads ab 0,20 % auf Hauptwährungen, gegenüber 1 bis 3 % bei Filialbanken.',
