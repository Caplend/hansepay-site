...
function rowToCustomer(row) {
  return {
    ...
    aiSummaryAt: row.ai_summary_at ? row.ai_summary_at.toISOString() : undefined,
...
const FIELD_MAP = {
  ...
  nextFollowUpAt: 'next_follow_up_at', lang: 'lang', aiSummary: 'ai_summary', aiSummaryAt: 'ai_summary_at',
};
...
const DATE_FIELDS = { lastContactAt: true, nextFollowUpAt: true, aiSummaryAt: true };
