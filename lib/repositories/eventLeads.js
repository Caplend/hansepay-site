...
async function updateLeadMessage(id, draftMessage) {
  await pool.query('UPDATE event_leads SET draft_message = :draftMessage WHERE id = :id', { id, draftMessage });
}
...
module.exports = { listImports, findImportById, createImportWithLeads, listLeadsForImport, findLeadById, updateLeadStatus, updateLeadNotes, updateLeadMessage, deleteImport };
