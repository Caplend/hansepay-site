...
// Gradient header — centered logo + wordmark + subtitle text.
function emailHdr(subtitle) {
  return `
  <tr><td bgcolor="#0B1929" class="hp-header" style="background:#0B1929;background-image:linear-gradient(135deg,#0B1929 0%,#1E4E80 100%);padding:30px 40px 26px;text-align:center;">
