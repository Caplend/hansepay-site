...
function emailHdr(subtitle) {
  const pill = subtitle ? `<td valign="middle" align="right" style="padding-left:20px;">
      <table role="presentation" cellpadding="0" cellspacing="0" align="right">
        <tr><td style="padding:5px 14px;border-radius:100px;border:1px solid rgba(255,255,255,0.22);background:rgba(255,255,255,0.10);font-family:${SANS};font-size:9px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,0.68);white-space:nowrap;">${subtitle}</td></tr>
      </table>
    </td>` : '';
  return `
  <tr><td bgcolor="#071729" class="hp-header" style="background:#071729;background-image:linear-gradient(180deg,#071729 0%,#0E3260 100%);padding:20px 32px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="middle">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="middle" style="padding-right:10px;">${logoPill(28)}</td>
              <td valign="middle" class="hp-hdr-txt" style="font-family:${SERIF};font-size:19px;font-weight:400;color:#ffffff;letter-spacing:-.01em;white-space:nowrap;">HansePay</td>
            </tr>
          </table>
        </td>
        ${pill}
