...
function renderKycInviteIndividualEmail({ recipientName, recipientEmail, firstName, kycUrl, lang }) {
  ...
  const body = isDE
    ...
    : `to complete your HansePay account setup, you need to verify your identity. This is a regulatory requirement and takes just a few minutes. Tap the button below to verify securely through our trusted partner Signicat.`;
...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(11,25,41,.08);">
  ...
  <tr><td style="padding:36px 40px 28px;">
    ...
    <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:${BRAND.ink2};">${body}</p>
    ...
    ${supportLine(isDE ? 'Hilfe benötigt? Kontaktieren Sie uns unter' : 'Need help? Contact us at', supportEmail)}
  </td></tr>
