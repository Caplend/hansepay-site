...
// hansepay-mark-email-header.png: white mark on fully-opaque #0B1929 navy background.
// No transparency = no compositing issues = works in every email client (Spark, Gmail,
// Apple Mail, Outlook). This is the file that made the booking confirmation email work.
...
// Logo for all email dark headers/footers.
// Use the opaque-background PNG — transparent PNGs cause rendering issues
// (compositing, client-side inversion) across Spark, Apple Mail, Gmail.
