...
const COPY = {
  en: {
    ...
    callout:     'No hard sell. Just a candid conversation about where HansePay could genuinely save your business time and money.',
  ...
  de: {
    ...
    callout:     'Kein Verkaufsdruck. Nur ein offenes Gespräch darüber, wo HansePay Ihrem Unternehmen Zeit und Geld sparen kann.',
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 6px 28px rgba(11,25,41,.10);">
  ...
  <tr><td style="padding:36px 36px 8px;">
    ...
    <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:${BRAND.ink2};">${esc(t.intro(isRebook))}</p>

    <!-- Italic serif callout -->
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
      <tr><td style="border-left:3px solid ${BRAND.blue2};background:linear-gradient(135deg,#f4f9ff,#eef5fc);border-radius:0 8px 8px 0;padding:18px 22px;">
        <p style="margin:0;font-family:${SERIF};font-style:italic;font-size:17px;line-height:1.6;color:${BRAND.navy};">${esc(t.callout)}</p>
      </td></tr>
    </table>
