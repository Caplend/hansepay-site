...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(11,25,41,.08);">
  ...
  <tr><td style="padding:36px 40px 28px;">
    ...
    <p style="margin:0 0 8px;font-size:16px;color:${BRAND.ink};">${esc(t.hi(name))}</p>
    <p style="margin:0 0 28px;font-size:15px;line-height:1.65;color:${BRAND.ink2};">${esc(t.intro(repName))}</p>
    ...
    ${supportLine(lang === 'de' ? 'Fragen? Schreiben Sie an' : 'Questions? Reach out to', supportEmail)}
...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(11,25,41,.08);">
  ...
  <tr><td style="padding:36px 40px 28px;">
    ...
    <p style="margin:0 0 6px;font-size:15px;line-height:1.65;color:${BRAND.ink};">${greeting}</p>
    <p style="margin:0 0 28px;font-size:15px;line-height:1.65;color:${BRAND.ink2};">${body}</p>
...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(11,25,41,.08);">
  ...
  <tr><td style="padding:36px 40px 28px;">
    ...
    <p style="margin:0 0 6px;font-size:15px;line-height:1.65;color:${BRAND.ink};">${isDE ? `Hallo ${name},` : `Hi ${name},`}</p>
    <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:${BRAND.ink2};">${isDE
...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(11,25,41,.08);">
  ...
  <tr><td style="padding:36px 40px 28px;">
    ...
    <p style="margin:0 0 6px;font-size:15px;line-height:1.65;color:${BRAND.ink};">${isDE ? `Hallo ${admin},` : `Hi ${admin},`}</p>
    <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:${BRAND.ink2};">${isDE
