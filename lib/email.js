...
function emailHdr(subtitle) {
  ...
  return `
  <tr><td bgcolor="#071729" class="hp-header" style="background:#071729;background-image:linear-gradient(180deg,#071729 0%,#143860 100%);padding:26px 36px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="middle">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="middle" style="padding-right:11px;">${logoPill(32)}</td>
              <td valign="middle" class="hp-hdr-txt" style="font-family:${SERIF};font-size:20px;font-weight:400;color:#ffffff;letter-spacing:-.01em;white-space:nowrap;">HansePay</td>
            </tr>
          </table>
        </td>
        ${pill}
  ...
  <tr><td style="height:3px;background:linear-gradient(90deg,#2E6BAD,#8DBDE6);line-height:3px;font-size:0;">&nbsp;</td></tr>`;
}
