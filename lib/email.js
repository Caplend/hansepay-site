...
function emailHdr(subtitle) {
  ...
  return `
  <tr><td bgcolor="#0B1929" class="hp-header" style="background:#0B1929;background-image:-webkit-gradient(linear,left top,left bottom,from(#071729),to(#1E4E80));background-image:-webkit-linear-gradient(top,#071729 0%,#1E4E80 100%);background-image:linear-gradient(to bottom,#071729 0%,#1E4E80 100%);padding:36px 44px;">
...
function heroIcon(icon, bg) {
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 22px;">
    <tr><td align="center">
      <table role="presentation" cellpadding="0" cellspacing="0">
        <tr><td width="64" height="64" bgcolor="${bg}" style="background:${bg};border-radius:32px;text-align:center;vertical-align:middle;width:64px;height:64px;">
          <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;"><tr><td style="line-height:0;font-size:0;">${icon}</td></tr></table>
        </td></tr>
      </table>
    </td></tr>
  </table>`;
