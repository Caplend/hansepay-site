...
function emailHdr(subtitle) {
  ...
  return `
  <tr><td bgcolor="#0B1929" class="hp-header" style="background:#0B1929;background-image:-webkit-gradient(linear,left top,left bottom,from(#071729),to(#1E4E80));background-image:-webkit-linear-gradient(top,#071729 0%,#1E4E80 100%);background-image:linear-gradient(to bottom,#071729 0%,#1E4E80 100%);padding:30px 40px;">
